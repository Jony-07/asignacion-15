...
class EditorialesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $editorial->save();
        return redirect()->route('editoriales.index')->with('status','Editorial creado exitosamente!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $editorial->telefono=$request->telefono;
        $editorial->save();
        return redirect()->route('editoriales.index')->with('actualizado','Actualizado existosamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('editoriales.index')->with('state','Editorial eliminado exitosamente');
    }
}
